...
public class AddressCity2EditPart extends CompartmentEditPart implements ITextAwareEditPart
{
	...
	public IParser getParser()
	{
		if (parser == null)
		{
			parser = RentalParserProvider.getParser(RentalElementTypes.Address_3001, getParserElement(), RentalVisualIDRegistry
					.getType(com.opcoach.training.rental.diagram.edit.parts.AddressCity2EditPart.VISUAL_ID));
		}
		return parser;
	}
