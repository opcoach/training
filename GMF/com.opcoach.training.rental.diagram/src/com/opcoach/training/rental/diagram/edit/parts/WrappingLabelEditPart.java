...
public class WrappingLabelEditPart extends LabelEditPart implements ITextAwareEditPart
{
	...
	static
	{
		registerSnapBackPosition(RentalVisualIDRegistry.getType(com.opcoach.training.rental.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	public IParser getParser()
	{
		if (parser == null)
		{
			parser = RentalParserProvider.getParser(RentalElementTypes.RentalCustomer_4001, getParserElement(), CommonParserHint.DESCRIPTION);
		}
		return parser;
	}
