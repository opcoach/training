 ...
 * @generated
 */
public class RentalBaseItemSemanticEditPolicy extends SemanticEditPolicy
{
	 ...
	 * @generated
	 */
	protected RentalBaseItemSemanticEditPolicy(IElementType elementType)
	{
	...
	public Command getCommand(Request request)
	{
		if (request instanceof ReconnectRequest)
		{
			...
			{
				Integer id = new Integer(RentalVisualIDRegistry.getVisualID((View) view));
	...
	private Command getEditHelperCommand(IEditCommandRequest request, Command editPolicyCommand)
	{
		...
		request.setParameter(RentalBaseEditHelper.CONTEXT_ELEMENT_TYPE, requestContextElementType);
		ICommand command = requestContextElementType.getEditCommand(request);
		request.setParameter(RentalBaseEditHelper.EDIT_POLICY_COMMAND, null);
		request.setParameter(RentalBaseEditHelper.CONTEXT_ELEMENT_TYPE, null);
		if (command != null)
		{
	...
	{
		IElementType requestContextElementType = RentalElementTypes.getElementType(getVisualID(request));
	...
	public static class LinkConstraints
	{
		...
		public static boolean canCreateRentalCustomer_4001(Rental source, Customer target)
		{
			...
			return canExistRentalCustomer_4001(source, target);
		}
		...
		public static boolean canCreateRentalRentedObject_4002(Rental source, RentalObject target)
		{
			if (source != null)
			{
				if (source.getRentedObject() != null)
				{
					return false;
				}
			}

			return canExistRentalRentedObject_4002(source, target);
		}
