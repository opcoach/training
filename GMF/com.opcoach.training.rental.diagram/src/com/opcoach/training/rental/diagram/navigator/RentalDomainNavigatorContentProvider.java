 ...
 * @generated
 */
public class RentalDomainNavigatorContentProvider implements ICommonContentProvider
{
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement)
	{
		...
		for (int i = 0; i < objects.length; i++)
		{
			...
			{
				result.add(new RentalDomainNavigatorItem((EObject) objects[i], parentElement, myAdapterFctoryContentProvier));
			}
		}
