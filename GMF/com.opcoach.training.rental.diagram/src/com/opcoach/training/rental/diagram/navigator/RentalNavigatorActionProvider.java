...
import com.opcoach.training.rental.diagram.part.RentalDiagramEditor;
 ...
 * @generated
 */
public class RentalNavigatorActionProvider extends CommonActionProvider
{
	...
	private class OpenDiagramAction extends Action
	{
		...
		public final void selectionChanged(IStructuredSelection selection)
		{
			...
			if (selection.size() == 1)
			{
				...
				if (selectedElement instanceof Diagram)
				{
					...
					if (RentalAgencyEditPart.MODEL_ID.equals(RentalVisualIDRegistry.getModelID(diagram)))
					{
						myDiagram = diagram;
					}
				}
		...
		public void run()
		{
			...
			try
			{
				page.openEditor(editorInput, RentalDiagramEditor.ID);
			} catch (PartInitException e)
			{
				RentalDiagramEditorPlugin.getInstance().logError("Exception while openning diagram", e); //$NON-NLS-1$
			}
		}
