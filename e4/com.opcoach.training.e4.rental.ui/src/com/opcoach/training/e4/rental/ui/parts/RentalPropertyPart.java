...
public class RentalPropertyPart {
	...
	public void setRental(Rental r) {
		...
		/*
		 * if (rentedObjectLabel == null) return; // ui not created yet if (r == null) {
		 * rentedObjectLabel.setText("                               ");
		 * customerNameLabel.setText(" "); startDateLabel.setText(" ");
		 * endDateLabel.setText("                                    "); } else {
		 * rentedObjectLabel.setText(r.getRentedObject().getName()); Customer c =
		 * r.getCustomer(); customerNameLabel.setText(c.getDisplayName());
		 * 
	...
	protected DataBindingContext initDataBindings() {
		...
		IObservableValue displayNameCurrentRentalgetCustomerObserveValue = PojoProperties.value("displayName")
				.observe(currentRental.getCustomer());
		...
		IObservableValue currentRentalStartDateObserveValue = EMFObservables.observeValue(currentRental,
				Literals.RENTAL__START_DATE);
		UpdateValueStrategy strategy = new UpdateValueStrategy();
		strategy.setConverter(new DateToStringConverter());
		bindingContext.bindValue(observeTextStartDateLabelObserveWidget, currentRentalStartDateObserveValue, null,
				strategy);
		//
