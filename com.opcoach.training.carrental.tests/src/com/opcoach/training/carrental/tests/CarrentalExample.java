...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>carrental</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class CarrentalExample
{
	...
	public static void main(String[] args)
	{
		...
		resourceSet.getPackageRegistry().put
			(CarrentalPackage.eNS_URI, 
			 CarrentalPackage.eINSTANCE);
		...
		if (args.length == 0)
		{
			...
			try
			{
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.carrental"));
				Car root = CarrentalFactory.eINSTANCE.createCar();
