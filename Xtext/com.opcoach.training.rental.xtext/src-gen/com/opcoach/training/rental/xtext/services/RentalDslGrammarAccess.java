...
public class RentalDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	private RentalAgencyElements pRentalAgency;
	private EStringElements pEString;
	private AddressElements pAddress;
	private RentalObjectElements pRentalObject;
	private CustomerElements pCustomer;
	private RentalElements pRental;
	private StreetTypeElements unknownRuleStreetType;
	...
	public RentalAgencyElements getRentalAgencyAccess() {
		return (pRentalAgency != null) ? pRentalAgency : (pRentalAgency = new RentalAgencyElements());
	}
	...
	public CustomerElements getCustomerAccess() {
		return (pCustomer != null) ? pCustomer : (pCustomer = new CustomerElements());
	}
	...
	public RentalElements getRentalAccess() {
		return (pRental != null) ? pRental : (pRental = new RentalElements());
	}
	...
	public StreetTypeElements getStreetTypeAccess() {
		return (unknownRuleStreetType != null) ? unknownRuleStreetType : (unknownRuleStreetType = new StreetTypeElements());
	}
