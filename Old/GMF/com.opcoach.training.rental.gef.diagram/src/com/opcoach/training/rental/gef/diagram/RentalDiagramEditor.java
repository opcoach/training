...
public class RentalDiagramEditor extends DiagramEditor
{
	...
	protected PaletteRoot getPaletteRoot()
	{
		...
		PaletteEntry custTool = new CreationToolEntry("Customer", "Cr�ation du client",rf,null,null);
		group2.add(custTool);

		rf = new RentalCreationFactory(RentalObject.class);
		PaletteEntry objTool = new CreationToolEntry("Rental Object", "Cr�ation de l'objet",rf,null, null);
		group2.add(objTool);

		rf = new RentalCreationFactory(Rental.class);
		PaletteEntry rentalTool = new CreationToolEntry("Rental", "Cr�ation d'une location",rf,null,null);
