 ...
 * @generated
 */
public class RentalNewDiagramFileWizard extends Wizard
{
	 ...
	 * @generated
	 */
	public RentalNewDiagramFileWizard(URI domainModelURI, EObject diagramRoot, TransactionalEditingDomain editingDomain)
	{
	...
	public boolean performFinish()
	{
		...
		try
		{
			...
			diagramResource.save(RentalDiagramEditorUtil.getSaveOptions());
			RentalDiagramEditorUtil.openDiagram(diagramResource);
		} catch (ExecutionException e)
		{
			RentalDiagramEditorPlugin.getInstance().logError("Unable to create model and diagram", e); //$NON-NLS-1$
		} catch (IOException ex)
		{
			RentalDiagramEditorPlugin.getInstance().logError("Save operation failed for: " + diagramModelURI, ex); //$NON-NLS-1$
		} catch (PartInitException ex)
		{
			RentalDiagramEditorPlugin.getInstance().logError("Unable to open editor", ex); //$NON-NLS-1$
		}
		return true;
	}
	...
	private static class DiagramRootElementSelectionPage extends ModelElementSelectionPage
	{
		...
		{
			return Messages.RentalNewDiagramFileWizard_RootSelectionPageSelectionTitle;
		}
		...
		protected boolean validatePage()
		{
			...
			{
				setErrorMessage(Messages.RentalNewDiagramFileWizard_RootSelectionPageNoSelectionMessage);
				return false;
			}
