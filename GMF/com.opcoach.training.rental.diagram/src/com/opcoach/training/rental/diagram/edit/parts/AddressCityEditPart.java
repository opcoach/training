...
public class AddressCityEditPart extends CompartmentEditPart implements ITextAwareEditPart
{
	...
	public IParser getParser()
	{
		if (parser == null)
		{
			parser = RentalParserProvider.getParser(RentalElementTypes.Address_2001, getParserElement(), RentalVisualIDRegistry
					.getType(com.opcoach.training.rental.diagram.edit.parts.AddressCityEditPart.VISUAL_ID));
		}
		return parser;
	}
