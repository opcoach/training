...
import com.opcoach.training.rental.diagram.edit.policies.RentalTextSelectionEditPolicy;
 ...
 * @generated
 */
public class CustomerFirstNameLastNameEditPart extends CompartmentEditPart implements ITextAwareEditPart
{
	 ...
	 * @generated
	 */
	public CustomerFirstNameLastNameEditPart(View view)
	{
		super(view);
	}
	...
	protected Image getLabelIcon()
	{
		...
		return RentalElementTypes.getImage(parserElement.eClass());
	}
	...
	public void setLabelText(String text)
	{
		...
		if (pdEditPolicy instanceof RentalTextSelectionEditPolicy)
		{
			((RentalTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof RentalTextSelectionEditPolicy)
		{
			((RentalTextSelectionEditPolicy) sfEditPolicy).refreshFeedback();
		}
	}
	...
	public IParser getParser()
	{
		if (parser == null)
		{
			parser = RentalParserProvider.getParser(RentalElementTypes.Customer_2003, getParserElement(), RentalVisualIDRegistry
					.getType(com.opcoach.training.rental.diagram.edit.parts.CustomerFirstNameLastNameEditPart.VISUAL_ID));
		}
		return parser;
	}
